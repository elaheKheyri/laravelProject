...
<center>  
                ...
                <label style= " font-family: Bnazanin ; color: #8B0000 ; font-weight: bold "> : ارتباط با ما</label>
				<br> </br>
              ...
              <form action="/edit/contact" method="POST" enctype="multipart/form-data" style="font-size: 16px">
              @csrf
